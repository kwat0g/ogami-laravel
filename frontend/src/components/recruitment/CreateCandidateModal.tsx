  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
        <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add Candidate to Pool</h2>
        <p className="mb-6 text-sm text-gray-500">Add a candidate for proactive sourcing or future openings.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-500 uppercase">Source</label>
          ...
          <div>
            <label className="block text-xs font-medium text-gray-500 uppercase">LinkedIn URL</label>
