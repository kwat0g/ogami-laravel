              ...
              <tbody className="divide-y divide-neutral-100">
                ...
                {data?.data?.map((po) => (
                  <tr key={po.id} className="hover:bg-neutral-50/50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <Link to={`/procurement/purchase-orders/${po.ulid}`} className="inline-block px-2 py-1 text-xs border border-neutral-300 rounded bg-white text-neutral-600 hover:bg-neutral-50 hover:border-neutral-400 hover:text-neutral-900 font-medium">
                        View
                      </Link>
                    </td>
                  </tr>
