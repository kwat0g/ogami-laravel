  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900">Vendor Credit Notes</h1>
          <p className="text-sm text-neutral-500">AP credit notes issued to vendors.</p>
        </div>
        {canCreate && (
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-white border border-neutral-200 rounded-lg p-5 mb-6 grid grid-cols-3 gap-4">
          <div>
            ...
            <input type="number" min={1} value={form.vendor_id || ''} onChange={(e) => setForm(f => ({ ...f, vendor_id: Number(e.target.value) }))}
