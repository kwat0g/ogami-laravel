        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-3 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Leave Type</th>
              <th className="px-3 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Period</th>
              <th className="px-3 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Days</th>
              ...
              <th className="px-3 py-2.5 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Filed On</th>
            </tr>
          </thead>
                        ...
                        <div className="bg-white rounded-lg p-4 border border-gray-200">
                          ...
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="text-gray-900">{row.is_half_day ? (row.half_day_period === 'AM' ? 'Morning' : 'Afternoon') : 'No'}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-gray-500">Filed By:</span>
                              <span className="text-gray-900">User #{row.submitted_by}</span>
                            </div>
                          </div>
                        </div>
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm">
                                  ...
                                  {row.reviewer_remarks && (
                                    <p className="text-gray-600 mt-1 bg-gray-50 p-2 rounded text-xs">
                                      "{row.reviewer_remarks}"
                                    </p>
                                  )}
                                </div>
                            ...
                            {!row.reviewed_at && (
                              <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm">
                                  ...
                                  <p className="text-gray-500">Waiting for supervisor/manager review</p>
                                </div>
                              </div>
                            )}
                          </div>
