...
export default function CreateMaterialRequisitionPage(): React.ReactElement {
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-lg font-semibold text-neutral-900 mb-6">New Material Requisition</h1>
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div className="bg-white border border-neutral-200 rounded p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-medium text-neutral-700">Requested Items</h2>
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs px-3 py-2 border border-neutral-300 text-neutral-700 rounded hover:bg-neutral-50"
              >
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="px-6 py-2 bg-neutral-900 hover:bg-neutral-800 text-white text-sm font-medium rounded disabled:opacity-50"
          >
