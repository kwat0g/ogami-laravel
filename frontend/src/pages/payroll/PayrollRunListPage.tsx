    ...
    <div>
      ...
      <div className="bg-white border border-neutral-200 rounded p-4 mb-4 flex flex-wrap gap-3">
        ...
        <select
          ...
          className="border border-neutral-300 rounded px-3 py-2 text-sm bg-white focus:ring-2 focus:ring-neutral-500 outline-none"
        >
          {YEARS.map((y) => (
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead className="bg-neutral-50 border-b border-neutral-200">
              <tr>
                <th className="px-3 py-2.5 text-left text-xs font-semibold text-neutral-500 font-medium">Reference</th>
                <th className="px-3 py-2.5 text-left text-xs font-semibold text-neutral-500 font-medium">Period</th>
                <th className="px-3 py-2.5 text-left text-xs font-semibold text-neutral-500 font-medium">Pay Date</th>
                <th className="px-3 py-2.5 text-left text-xs font-semibold text-neutral-500 font-medium">Status</th>
                <th className="px-3 py-2.5 text-right text-xs font-semibold text-neutral-500 font-medium">Employees</th>
            ...
            <tbody className="divide-y divide-neutral-100">
              {(data?.data ?? []).length === 0 ? (
                ...
                (data?.data ?? []).map((run) => (
                  ...
                  >
                    <td className="px-3 py-2 font-mono text-xs text-neutral-700 font-medium">
                      {run.reference_no}
                    </td>
