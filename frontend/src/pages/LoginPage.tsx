  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Use your Ogami ERP credentials</p>
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-primary-600 text-white rounded-lg px-4 py-2 text-sm font-medium
