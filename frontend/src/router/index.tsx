...
const DeliveryDisputeDetailPage       = lazyWithRetry(() => import('@/pages/delivery/DeliveryDisputeDetailPage'))
...
const router = createBrowserRouter([
  ...
  // ── App shell (requires authentication) ─────────────────────────────────
  {
    ...
    children: [
      ...
      { path: '/payroll/runs/:ulid/hr-review', element: withSuspense(guard('payroll.hr_approve|payroll.initiate|hr.full_access', <PayrollRunHrReviewPage />)) },
      { path: '/payroll/runs/:ulid/acctg-review', element: withSuspense(guard('payroll.acctg_approve|payroll.approve|payroll.hr_approve|hr.full_access', <PayrollRunAcctgReviewPage />)) },
      ...
      { path: '/inventory/item-movements', element: withSuspense(guard('inventory.stock.view', <StockLedgerPage />)) },
      { path: '/inventory/ledger', element: <Navigate to="/inventory/item-movements" replace /> },
    ...
    { path: '/production/orders', element: withSuspense(guard('production.orders.view', <ProductionOrderListPage />)) },
      ...
      { path: '/delivery/disputes/:ulid', element: withSuspense(guard('delivery.view', <DeliveryDisputeDetailPage />)) },
