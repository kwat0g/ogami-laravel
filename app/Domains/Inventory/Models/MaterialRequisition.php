...
final class MaterialRequisition extends Model implements Auditable
{
    ...
    /** @return BelongsTo<User, MaterialRequisition> */
    public function vpApprovedBy(): BelongsTo { return $this->belongsTo(User::class, 'vp_approved_by_id'); }

    /** @return BelongsTo<User, MaterialRequisition> */
    public function rejectedBy(): BelongsTo { return $this->belongsTo(User::class, 'rejected_by_id'); }

    /** @return BelongsTo<User, MaterialRequisition> */
    public function fulfilledBy(): BelongsTo { return $this->belongsTo(User::class, 'fulfilled_by_id'); }
