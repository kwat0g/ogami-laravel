...
final class ProductionOrderReleasedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'type' => 'production.order_released',
            'title' => 'Production Order Released',
            'message' => sprintf(
                'Production order %s has been released. Materials have been deducted from inventory.',
                $this->orderNumber,
            ),
