...
final class OfferExpiredNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'type' => 'recruitment.offer.expired',
            'title' => 'Offer Expired',
            'message' => sprintf('Offer %s for %s (%s) has expired without a response.', $this->offerNumber, $this->candidateName, $this->positionTitle),
