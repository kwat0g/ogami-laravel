 ...
 *
 * Extracted from routes/api/v1/dashboard.php route closures.
 * Each public method corresponds to a role-specific dashboard endpoint.
 *
 * TODO: Incrementally extract DB queries into DashboardKpiService
 * or RoleBasedDashboardService for full ARCH-001 compliance.
 */
final class DashboardController extends Controller
{
    ...
    /**
     * Kpis/Supplementary Dashboard.
     * GET /api/v1/dashboard/kpis/supplementary
     */
    public function supplementaryKpis(Request $request)
    {
