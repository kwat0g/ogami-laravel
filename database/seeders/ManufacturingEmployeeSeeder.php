...
class ManufacturingEmployeeSeeder extends Seeder
{
    ...
    private function getEmployeeData(): array
    {
        return [
            // ── Executive Management ──────────────────────────────────────────
            [
                'code' => 'EMP-2026-0006', 'middle_name' => 'Santos', 'reg_date' => '2010-07-04', 'first_name' => 'Roberto',     'last_name' => 'Ogami',
            ...
            [
                'code' => 'EMP-2026-0007', 'middle_name' => 'Reyes', 'reg_date' => '2010-07-04', 'first_name' => 'Eduardo',     'last_name' => 'Ogami',
            ...
            [
                'code' => 'EMP-2026-0008', 'middle_name' => 'Garcia', 'reg_date' => '2012-12-01', 'first_name' => 'Lorenzo',     'last_name' => 'Ogami',
            ...
            // ── Department Managers ───────────────────────────────────────────
            [
                'code' => 'EMP-2026-0009', 'middle_name' => 'Dela Cruz', 'reg_date' => '2015-09-01', 'first_name' => 'Carlos',      'last_name' => 'Reyes',
            ...
            [
                'code' => 'EMP-2026-0010', 'middle_name' => 'Santos', 'reg_date' => '2018-02-15', 'first_name' => 'Renaldo',     'last_name' => 'Mendoza',
            ...
            [
                'code' => 'EMP-2026-0011', 'middle_name' => 'Reyes', 'reg_date' => '2016-08-01', 'first_name' => 'Josephine',   'last_name' => 'Villanueva',
            ...
            [
                'code' => 'EMP-2026-0012', 'middle_name' => 'Legaspi', 'reg_date' => '2019-05-01', 'first_name' => 'Victor',      'last_name' => 'Castillo',
            ...
            // ── Officers ──────────────────────────────────────────────────────
            [
                'code' => 'EMP-2026-0013', 'middle_name' => 'Ocampo', 'reg_date' => '2019-11-06', 'first_name' => 'Rachel',      'last_name' => 'Garcia',
            ...
            [
                'code' => 'EMP-2026-0014', 'middle_name' => 'Santos', 'reg_date' => '2021-01-01', 'first_name' => 'Marlon',      'last_name' => 'Torres',
                ...
                'dept' => 'PURCH', 'pos' => 'PURCH-OFF', 'sg' => 'SG-10',
                'hired' => '2020-07-01', 'salary' => 15000000,
                'bank_name' => 'Metrobank', 'bank_account_no' => '6001000002',
            ],
            [
                'code' => 'EMP-2026-0015', 'middle_name' => 'Reyes', 'reg_date' => '2021-07-18', 'first_name' => 'Cristina',    'last_name' => 'Aquino',
            ...
            // ── Department Heads ──────────────────────────────────────────────
            [
                'code' => 'EMP-2026-0016', 'middle_name' => 'Dela Cruz', 'reg_date' => '2020-03-01', 'first_name' => 'Ernesto',     'last_name' => 'Bautista',
            ...
            [
                'code' => 'EMP-2026-0017', 'middle_name' => 'Santos', 'reg_date' => '2020-08-24', 'first_name' => 'Jerome',      'last_name' => 'Florido',
            ...
            [
                'code' => 'EMP-2026-0018', 'middle_name' => 'Cruz', 'reg_date' => '2017-01-11', 'first_name' => 'Armando',     'last_name' => 'Dela Torre',
            ...
            [
                'code' => 'EMP-2026-0019', 'middle_name' => 'Reyes', 'reg_date' => '2018-10-16', 'first_name' => 'Danilo',      'last_name' => 'Espiritu',
            ...
            [
                'code' => 'EMP-2026-0020', 'middle_name' => 'Garcia', 'reg_date' => '2020-05-04', 'first_name' => 'Eliza',       'last_name' => 'Navarro',
            ...
            [
                'code' => 'EMP-2026-0021', 'middle_name' => 'Mendoza', 'reg_date' => '2017-09-20', 'first_name' => 'Rhodora',     'last_name' => 'Salazar',
            ...
            [
                'code' => 'EMP-2026-0022', 'middle_name' => 'Ocampo', 'reg_date' => '2021-04-05', 'first_name' => 'Bernard',     'last_name' => 'Pineda',
            ...
            [
                'code' => 'EMP-2026-0023', 'middle_name' => 'Santos', 'reg_date' => '2023-12-01', 'first_name' => 'Pedro',       'last_name' => 'dela Cruz',
    ...
    private function getUserAccountData(): array
    {
        return [
            ...
            ['email' => 'plant.manager@ogamierp.local',   'name' => 'Carlos Reyes',         'password' => 'Manager@12345!',   'role' => 'manager'],
