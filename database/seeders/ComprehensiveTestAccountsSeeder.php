...
class ComprehensiveTestAccountsSeeder extends Seeder
{
    ...
    private function printAccountSummary(): void
    {
        ...
        $accounts = [
            ...
            ['HR', 'hr.officer@ogamierp.local', 'Officer@Test1234!', 'HR Officer', 'EMP-HR-001'],
            ['HR', 'hr.manager@ogamierp.local', 'Manager@Test1234!', 'HR Manager', 'EMP-HR-002'],
            ['HR', 'hr.head@ogamierp.local', 'Head@Test1234!', 'HR Head', 'EMP-HR-003'],
            ['HR', 'hr.staff@ogamierp.local', 'Staff@Test1234!', 'HR Staff', 'EMP-HR-004'],
            ['ACCTG', 'acctg.officer@ogamierp.local', 'Officer@Test1234!', 'Accounting Officer', 'EMP-ACCT-001'],
            ['ACCTG', 'acctg.manager@ogamierp.local', 'Manager@Test1234!', 'Accounting Manager', 'EMP-ACCT-002'],
            ...
            ['PROD', 'prod.officer@ogamierp.local', 'Officer@Test1234!', 'Production Officer', 'EMP-PROD-001'],
            ['PROD', 'prod.manager@ogamierp.local', 'Manager@Test1234!', 'Production Manager', 'EMP-PROD-002'],
            ['PROD', 'prod.head@ogamierp.local', 'Head@Test1234!', 'Production Head', 'EMP-PROD-003'],
            ['PROD', 'prod.staff@ogamierp.local', 'Staff@Test1234!', 'Production Staff', 'EMP-PROD-004'],
            ['QC', 'qc.officer@ogamierp.local', 'Officer@Test1234!', 'QC Officer', 'EMP-QC-001'],
            ['QC', 'qc.manager@ogamierp.local', 'Manager@Test1234!', 'QC Manager', 'EMP-QC-002'],
            ['QC', 'qc.head@ogamierp.local', 'Head@Test1234!', 'QC Head', 'EMP-QC-003'],
            ['QC', 'qc.staff@ogamierp.local', 'Staff@Test1234!', 'QC Staff', 'EMP-QC-004'],
            ['MOLD', 'mold.officer@ogamierp.local', 'Officer@Test1234!', 'Mold Officer', 'EMP-MOLD-001'],
            ['MOLD', 'mold.manager@ogamierp.local', 'Manager@Test1234!', 'Mold Manager', 'EMP-MOLD-002'],
            ['MOLD', 'mold.head@ogamierp.local', 'Head@Test1234!', 'Mold Head', 'EMP-MOLD-003'],
            ['MOLD', 'mold.staff@ogamierp.local', 'Staff@Test1234!', 'Mold Staff', 'EMP-MOLD-004'],
            ['PLANT', 'plant.officer@ogamierp.local', 'Officer@Test1234!', 'Plant Officer', 'EMP-PLANT-001'],
            ['PLANT', 'plant.manager@ogamierp.local', 'Manager@Test1234!', 'Plant Manager', 'EMP-PLANT-002'],
            ['PLANT', 'plant.head@ogamierp.local', 'Head@Test1234!', 'Plant Head', 'EMP-PLANT-003'],
            ['PLANT', 'plant.staff@ogamierp.local', 'Staff@Test1234!', 'Plant Staff', 'EMP-PLANT-004'],
            ['WH', 'wh.officer@ogamierp.local', 'Officer@Test1234!', 'Warehouse Officer', 'EMP-WH-001'],
            ['WH', 'wh.manager@ogamierp.local', 'Manager@Test1234!', 'Warehouse Manager', 'EMP-WH-002'],
            ['WH', 'wh.head@ogamierp.local', 'Head@Test1234!', 'Warehouse Head', 'EMP-WH-003'],
            ['WH', 'wh.staff@ogamierp.local', 'Staff@Test1234!', 'Warehouse Staff', 'EMP-WH-004'],
            ['PPC', 'ppc.officer@ogamierp.local', 'Officer@Test1234!', 'PPC Officer', 'EMP-PPC-001'],
            ['PPC', 'ppc.manager@ogamierp.local', 'Manager@Test1234!', 'PPC Manager', 'EMP-PPC-002'],
            ['PPC', 'ppc.head@ogamierp.local', 'Head@Test1234!', 'PPC Head', 'EMP-PPC-003'],
            ['PPC', 'ppc.staff@ogamierp.local', 'Staff@Test1234!', 'PPC Staff', 'EMP-PPC-004'],
            ['MAINT', 'maint.officer@ogamierp.local', 'Officer@Test1234!', 'Maintenance Officer', 'EMP-MAINT-001'],
            ['MAINT', 'maint.manager@ogamierp.local', 'Manager@Test1234!', 'Maintenance Manager', 'EMP-MAINT-002'],
            ['MAINT', 'maint.head@ogamierp.local', 'Head@Test1234!', 'Maintenance Head', 'EMP-MAINT-003'],
            ['MAINT', 'maint.staff@ogamierp.local', 'Staff@Test1234!', 'Maintenance Staff', 'EMP-MAINT-004'],
            ['ISO', 'iso.officer@ogamierp.local', 'Officer@Test1234!', 'ISO Officer', 'EMP-ISO-001'],
            ['ISO', 'iso.manager@ogamierp.local', 'Manager@Test1234!', 'ISO Manager', 'EMP-ISO-002'],
            ['ISO', 'iso.head@ogamierp.local', 'Head@Test1234!', 'ISO Head', 'EMP-ISO-003'],
            ['ISO', 'iso.staff@ogamierp.local', 'Staff@Test1234!', 'ISO Staff', 'EMP-ISO-004'],
            ['PURCH', 'purch.officer@ogamierp.local', 'Officer@Test1234!', 'Purchasing Officer', 'EMP-PURCH-001'],
            ['PURCH', 'purch.manager@ogamierp.local', 'Manager@Test1234!', 'Purchasing Manager', 'EMP-PURCH-002'],
            ['PURCH', 'purch.head@ogamierp.local', 'Head@Test1234!', 'Purchasing Head', 'EMP-PURCH-003'],
            ['PURCH', 'purch.staff@ogamierp.local', 'Staff@Test1234!', 'Purchasing Staff', 'EMP-PURCH-004'],
            ['SALES', 'sales.officer@ogamierp.local', 'Officer@Test1234!', 'Sales Officer', 'EMP-SALES-001'],
            ['SALES', 'sales.manager@ogamierp.local', 'Manager@Test1234!', 'Sales Manager', 'EMP-SALES-002'],
            ['SALES', 'sales.head@ogamierp.local', 'Head@Test1234!', 'Sales Head', 'EMP-SALES-003'],
            ['SALES', 'sales.staff@ogamierp.local', 'Staff@Test1234!', 'Sales Staff', 'EMP-SALES-004'],
            ['IT', 'it.officer@ogamierp.local', 'Officer@Test1234!', 'IT Officer', 'EMP-IT-001'],
            ['IT', 'it.manager@ogamierp.local', 'Manager@Test1234!', 'IT Manager', 'EMP-IT-002'],
            ['IT', 'it.head@ogamierp.local', 'Head@Test1234!', 'IT Head', 'EMP-IT-003'],
            ['IT', 'it.staff@ogamierp.local', 'Staff@Test1234!', 'IT Staff', 'EMP-IT-004'],
