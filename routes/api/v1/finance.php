...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::patch('journal-entries/{journalEntry}/post', [JournalEntryController::class, 'post'])
        ->middleware('sod:journal_entries,post')
    ...
    Route::patch('ap/invoices/{apInvoice}/head-note', [VendorInvoiceController::class, 'headNote'])
        ->middleware('sod:vendor_invoices,approve')
    ...
    Route::get('ap/credit-notes/{vendorCreditNote}', [VendorCreditNoteController::class, 'show'])
        ->name('vendor-credit-notes.show');

    Route::patch('ap/credit-notes/{vendorCreditNote}/post', [VendorCreditNoteController::class, 'post'])
        ->middleware(['sod:vendor_credit_notes,post', 'throttle:api-action'])
    ...
    Route::patch('bank-reconciliations/{reconciliation}/certify', [BankReconciliationController::class, 'certify'])
        ->middleware('sod:bank_reconciliations,certify')
